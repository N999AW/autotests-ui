...
def test_check_categories(page: Page):
    data = {
        "https://re-store.ru/apple/": [
            "iPhone",
            "Mac",
            "Watch",
            "iPad",
        ...
        "https://re-store.ru/smartfony-i-gadzhety/": [
            "Смартфоны",
            "Планшеты",
            "Умные часы",
            "Фитнес-браслеты",
        ...
        "https://re-store.ru/kompyutery-i-noutbuki/": [
            "Ноутбуки",
            "Моноблоки",
        ...
        "https://re-store.ru/tv-audio-video/": [
        ...
        "https://re-store.ru/krasota-i-zdorove/": [
        ...
        "https://re-store.ru/razvlecheniya/": [
            "Гейминг",
            "Дроны",
            "Роботы и игрушки",
            "Обучение",
        ...
        "https://re-store.ru/puteshestviya-i-sport/": [
            "Сумки и рюкзаки",
            "Умные бутылки",
...
def test_check_catalog(page: Page):
    page.goto("https://re-store.ru/naushniki/brand_apple/")
